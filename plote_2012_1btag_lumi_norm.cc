{
  ...
  c1.SaveAs("plots/1btag/nBJets_semie.pdf");
  ...
  c1.SaveAs("plots/1btag/mtt_1btag_semie_log.pdf");
  ...
  c1.SaveAs("plots/1btag/Electron_pt.pdf");

  p.plotstack_ratio("h1stjetpt", 4);
  c1.SaveAs("plots/1btag/firstjet_semie.pdf");

  p.plotstack_ratio("h2ndjetpt", 4);
  c1.SaveAs("plots/1btag/secondjet_semie.pdf");

  p.plotstack_ratio("h3rdjetpt", 4);
  c1.SaveAs("plots/1btag/thirdjet_semie.pdf");

  p.plotstack_ratio("h4thjetpt", 4, false, 1, "4^{th} jet p_{T} [GeV/c]");
  c1.SaveAs("plots/1btag/fourthjet_semie.pdf");

  p.plotstack_ratio("hMET", 4);
  c1.SaveAs("plots/1btag/MET_semie.pdf");

  p.plotstack_ratio("hNVtx", 2);
  c1.SaveAs("plots/1btag/nvertex_semie.pdf");

  p.plotstack_ratio("hNVtx", 2);
  c1.SaveAs("plots/1btag/nvertex_ratio_semie.pdf");
